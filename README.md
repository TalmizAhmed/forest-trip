...
## Environments
- Preview: https://main--forest-trip--TalmizAhmed.hlx.page/
- Live: https://main--forest-trip--TalmizAhmed.hlx.live/
...
1. Open the `forest-trip` directory in your favorite IDE and start coding :)
